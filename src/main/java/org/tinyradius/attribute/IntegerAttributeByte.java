 ...
 * contains a 8 bit integer.
 */
public class IntegerAttributeByte extends RadiusAttribute {

	/**
	 * Constructs an empty integer attribute.
	 */
	public IntegerAttributeByte() {
		super();
	}
	 ...
	 */
	public IntegerAttributeByte(int type, int value) {
	...
	throws RadiusException {
		if ( length != 3)
			throw new RadiusException("integer attribute: expected 1 byte data");
